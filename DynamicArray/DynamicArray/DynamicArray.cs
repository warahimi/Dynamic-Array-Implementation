...
class MyDynamicArray
{
    ...
    private int[] array;      // The static array to store elements, declared but not instantiated
    ...
    public void inserAtIndex(int item, int index)
    {
    ...
    private void grow()
    {
        ...
        int[] newArray = new int[capacity];  // Create a new array with the increased capacity
